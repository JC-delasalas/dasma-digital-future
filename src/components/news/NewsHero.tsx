...
const NewsHero: React.FC<NewsHeroProps> = ({ isSeniorMode }) => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className={`text-gov-neutrals-gray100 mb-8 ${isSeniorMode ? 'text-xl' : 'text-lg'}`}>
            Stay informed with the latest news, announcements, and advisories from the City Government of Dasmariñas.
          </p>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <div className="flex">
              <input
                type="text"
                placeholder="Search news, announcements, advisories..."
